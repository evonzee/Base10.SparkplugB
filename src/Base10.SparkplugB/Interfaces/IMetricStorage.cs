...
namespace Base10.SparkplugB.Interfaces
{
	...
	public interface IMetricStorage
	{
		...
		/// <returns></returns>
		public Task<IMetric> AddNodeMetric(string name, Base10.SparkplugB.Protocol.DataType type, object value, bool hasAlias = true);
		...
		/// included in *BIRTH messages, and all packets containing this tag will use the full name</param>
		/// <returns></returns>
		public Task<IDeviceMetric> AddDeviceMetric(string deviceName, string name, Base10.SparkplugB.Protocol.DataType type, object value, bool hasAlias = true);
